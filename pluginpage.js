/**
 * @summary     DataTables
 * @description Easily save all web site accesses: SITE,SITE Login,SITE Username,SITE Password,FTP,FTP Username,FTP Password,C-PANEL:,C-PANEL Username,C-PANEL Password,HOSTING,HOSTING Username,HOSTING Password
 * @version     1.0
 * @file        /
 * @author      Plamen Yordanov (https://websitepr.eu/about/)
 * @contact     https://websitepr.eu/contacts/
 *
 * @copyright Copyright 2008-2018 Plamen Yordanov, all rights reserved.
 */
